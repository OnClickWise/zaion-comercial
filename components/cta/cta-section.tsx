...
export default function CTAFormSection() {
  return (
    <section className="relative w-full bg-[#0B1F3B] py-16 md:py-24 overflow-hidden">
      
      {/* Glow */}
      <div className="absolute -top-32 -left-32 w-[300px] md:w-[400px] h-[300px] md:h-[400px] bg-[#C6A75E]/20 rounded-full blur-3xl" />
      ...
      <div className="relative w-full px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center">
          ...
          <div className="space-y-5 md:space-y-6 text-white">
            ...
            <div className="text-[#C6A75E] font-medium text-sm sm:text-base">
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-[#0B1F3B] mb-5 md:mb-6">
            ...
            <form className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full px-4 py-3 text-sm rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#C6A75E]"
                />
                <input
                  type="text"
